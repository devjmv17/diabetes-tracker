...
import { COLORES_MOMENTOS, MOMENTOS_DIA } from "../lib/constants"
...
export default function TablaTodosRegistros({ onCerrar }: TablaTodosRegistrosProps) {
  ...
  const dibujarGrafico = () => {
    ...
    Object.entries(registrosPorMomento).forEach(([momento, registrosMomento]) => {
      ...
      const color = COLORES_MOMENTOS[momento as MomentoDia]
    ...
    registrosFiltrados
      ...
      .forEach((registro, index) => {
        ...
        const colorPunto = COLORES_MOMENTOS[registro.momento]
      ...
      <body>
        ...
        <div class="grafico-section">
          ...
          <div class="momentos-leyenda">
            ${Object.entries(COLORES_MOMENTOS)
              ...
              <CardContent>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    {Object.entries(COLORES_MOMENTOS).map(([momento, color]) => (
                      <button
                        key={momento}
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{ backgroundColor: COLORES_MOMENTOS[registro.momento] }}
                        ></div>
                        <span
